...
prepareimage pack -m "SFU1" -k "..\FlySight_Bootloader\1_Image_SECoreBin\Binary\ECCKEY1.txt" -r 28 -v "1" -i "..\FlySight_Bootloader\1_Image_SECoreBin\Binary\iv.bin" -f "Binary\FlySight_STM32_MMG_New.sfu" -t "Binary\FlySight_STM32_MMG_New.sign" "Binary\fw.sfb" -o 512
