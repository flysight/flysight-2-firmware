...
typedef enum
{
  ...
  CUSTOM_STM_SD_CONTROL_POINT_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_SD_CONTROL_POINT_NOTIFY_DISABLED_EVT,
  /* SP_Control_Point */
  ...
  CUSTOM_STM_DS_MODE_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_DS_MODE_NOTIFY_DISABLED_EVT,
  /* DS_Control_Point */
  CUSTOM_STM_DS_CONTROL_POINT_WRITE_EVT,
  CUSTOM_STM_DS_CONTROL_POINT_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_DS_CONTROL_POINT_NOTIFY_DISABLED_EVT,
