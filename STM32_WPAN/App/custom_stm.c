...
/* Private variables ---------------------------------------------------------*/
static const uint8_t SizeCrs_Rx=20;
static const uint8_t SizeCrs_Tx=20;
/**
...
void SVCCTL_InitCustomSvc(void)
{
  ...
  aci_gatt_add_char(CustomContext.CustomCrsHdle,
                    UUID_TYPE_128, &uuid,
                    SizeCrs_Rx,
...
tBleStatus Custom_STM_App_Update_Char(Custom_STM_Char_Opcode_t CharOpcode, uint8_t *pPayload)
{
  ...
  switch(CharOpcode)
  {
    ...
    case CUSTOM_STM_CRS_RX:
      result = aci_gatt_update_char_value(CustomContext.CustomCrsHdle,
                                          CustomContext.CustomCrs_RxHdle,
                                          0, /* charValOffset */
